...
<body>
    <table border="0" cellpadding="0" cellspacing="0" style="margin:0 auto; padding:0; width: 1020px; background: #f6f6f6; font-family: Arial, Helvetica, sans-serif;">
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" style="margin:0 auto; padding:0; width: 640px; background: #ffffff; border-radius: 10px; box-shadow: 0 3px 8px 0 #f2f2f2;">
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="0">
                        <a href="#" style="text-decoration: none;">
                            <span style="display:block; width: 260px; margin:auto; height: 44px; line-height:44px; border-radius: 8px; background-color: #007fed; font-size: 16px; text-align: center; color: #ffffff; cursor: pointer">Complete my registration</span>
                        </a>
                    </td>
